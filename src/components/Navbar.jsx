...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleResize = () => {console.log("Resized"); setScreenSize(window.innerWidth)}
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <div className="flex">
        ...
        <NavButton title='Notifications' dotColor='#03c9d7' customFunc={() => {handleClick('notification')}} color='blue' icon={<RiNotificationLine />} />
        <TooltipComponent content='profile' position='BottomCenter' >
          <div className='flex items-center gap-2 cursor-pointer p-1 hover:bg-light-gray rounded-lg' onClick={() => {handleClick('userProfile')}}>
            <img className='rounded-full w-8 h-8' src={avatar} alt='avatar' />
            <p>
              <span className='text-gray-400 text-14'>Hi, </span>
              <span className='text-gray-400 text-14 font-bold ml-1'>Mohammed </span>
            </p>
